...
marca       ENUM ('LEGO','Mattel','Hasbro','Nintendo','Nerf', 'VTech','WowWee','Fisher-Price') NOT NULL,
precio      TINYINT NOT NULL,
categoria   ENUM('Muñecos y figuras','Contrucción y creatividad','Juegos educativos','Juegos de mesa','Vehículos y pistas','Juguetes tecnológicos') NOT NULL,
...
VALUES
('Bloques Creativos', 'Set de bloques para construir figuras', 'LEGO', 80, 'Contrucción y creatividad', 5, 30, '2025-01-10'),
